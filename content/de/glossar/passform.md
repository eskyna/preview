...
faq:
  items:
    - q: Ist die Größe auf dem Etikett entscheidend?
      a: Nein. Größen variieren stark. Entscheidend ist, wie das Teil an deinem Körper sitzt.
    - q: Wann lohnt sich eine Änderungsschneiderei?
      a: Wenn Material, Farbe und Stil stimmen und nur Länge oder kleine Weite korrigiert werden müssen.
    - q: Ist oversized schlechte Passform?
      a: Nein. Oversized kann sehr gut passen, wenn Schulter, Länge und Volumen bewusst gewählt sind.
seoTitle: Passform erklärt | ESKYNA Glossar
...
consulting_focus:
  Passform wird in der Beratung besonders relevant, wenn aus einem Begriff eine konkrete Entscheidung
