...
title: What does Color Type mean?
seoTitle: Color Type explained | ESKYNA Glossary
term: Color Type
description:
  Color Type describes which temperature, brightness, depth, and clarity of colors harmonize with your
  natural appearance.
...
faq:
  items:
    - q: Can my Color Type change?
      a: Core characteristics often stay stable, but hair color, tan, contrast, and styling can change the best implementation.
    - q: Are seasonal types precise enough?
      a: They give orientation, but they do not replace a closer look at temperature, depth, and clarity.
    - q: What about colors outside my type?
      a: You can still wear them, for example farther away from the face or in a better combination.
...
consulting_focus:
  Color Type becomes especially relevant in consultation when a concept needs to turn into a concrete
