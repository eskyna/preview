...
seoTitle: Proportion explained | ESKYNA Glossary
term: Proportion
description:
  Proportion describes the relationship between lengths, widths, and volume in an outfit and shapes balance,
  silhouette, and eye direction.
...
faq:
  items:
    - q: Can proportion matter more than size?
      a: Yes. A piece can be the right size and still look wrong in length or visual weight.
    - q: Do I need fixed body shape rules?
      a: No. Real outfit comparisons and desired impact are more useful.
    - q: How do I recognize good proportions?
      a: An outfit feels calmer when lengths, volume, and focal points work together intentionally.
...
consulting_focus:
  Proportion becomes especially relevant in consultation when a concept needs to turn into a concrete
