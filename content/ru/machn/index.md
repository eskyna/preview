...
hero:
  ...
  subline: Анализ цвета и стиля для основателей, которые хотят на следующем питче выглядеть ясно, уверенно и аутентично.
  festival_label: Фестивальная цена
  price: 290 €
  regular_price: вместо обычных 390 €
  cta_text: Запросить MACHN Special
  cta_href: "#machn-kontakt"
  meta_1: Для участников MACHN Festival
  meta_2: Можно забронировать до 30.06.2026
  badge: Покажите то, что есть в вас и вашей идее, — в том числе внешне.
  ...
  image_alt: Наталия Клеманн консультирует основателей по воздействию цвета и образу для питча
...
live_proof:
  ...
  logo_alt: Логотип MACHN Festival
use_cases:
  title: Use Cases
  items:
    - title: Питчи и выступления на сцене
...
result:
  ...
  image_alt: Наталия Клеманн в контексте ESKYNA с уверенным деловым впечатлением
  items:
    - Вы выглядите уверенно, ясно и аутентично.
    - Вы знаете, какие цвета усиливают ваше присутствие.
    - Ваш образ поддерживает ваше сообщение — а не наоборот.
    - Вы убеждаете с первого момента.
    - Для сцены, камеры, питча и бизнеса.
offer_card:
  title: ESKYNA MACHN SPECIAL
  subtitle: Анализ цвета и стиля для вашего pitch-образа
  price: 290 €
  regular_price: вместо обычных 390 €
  note: Можно забронировать до 30.06.2026 для участников MACHN Festival.
  cta_text: Запросить MACHN Special
  logo: images/machn/v3/machn-logo/machn-logo26-white-transparent.png
  logo_webp: images/machn/v3/machn-logo/machn-logo26-white-transparent.webp
  logo_alt: Логотип MACHN Festival 2026
